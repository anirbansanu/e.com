...
@section('content_body')
    <x-anilte::card headerClass="p-0 border-bottom-0" bodyClass="" footerClass="custom-footer-class" minimize maximize close>
        <x-slot name="header">
                ...
                <x-anilte::tab-nav-item route="users.edit" :routeParams="['user'=>$user->id]" icon="fas fa-plus-square">Edit User</x-anilte::tab-nav-item>
            ...
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-12 d-flex justify-content-end">
                        <x-adminlte-button type="submit" label="Update User" theme="primary" class="btn-md mt-3" icon="fas fa-save"/>
                    </div>
                </div>
            </form>
        </x-slot>
