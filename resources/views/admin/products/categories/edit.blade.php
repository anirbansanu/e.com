...
@section('content_body')
    <x-anilte::card headerClass="p-0 border-bottom-0 " bodyClass="" footerClass="custom-footer-class" minimize maximize close>
        <x-slot name="header">
                ...
                <x-anilte::tab-nav-item route="admin.products.categories.edit" routeParams="{{ $category->id }}" icon="fas fa-plus-square">Edit Category ( {{$category->name }})</x-anilte::tab-nav-item>
        </x-slot>
        <x-slot name="body">
               ...
               <x-adminlte-text-editor name="description" label="Description" label-class=""
                   ...
                   {!! $category->description !!}
                    ...
                    <div class="form-group d-flex justify-content-between">
                        ...
                        <x-adminlte-button type="submit" label="Update Category" theme="primary bg-gradient-blue" class="btn-md mt-3" icon="fas fa-save"/>
                    </div>
            </form>
        </x-slot>
