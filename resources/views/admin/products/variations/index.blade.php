                            ...
                            <table class="table table-hover text-nowrap border-top">
                                <thead class="border-top">
                                    <tr>
                                        <th>Sl no.</th>
                                        <th>
                                            <a class="sortable-link" href="{{ route('admin.variations.index', ['query' => $query, 'sort_by' => 'name', 'sort_order' => ($sort_by == 'name' && $sort_order == 'asc') ? 'desc' : 'asc']) }}">
                                ...
                                <tbody>
                                    @foreach($variations as $variation)
                                        <tr>
                                            <td>{{$variations->firstItem() + $loop->index}}</td>
                                            <td>{{ $variation->name }}</td>

                                            <td>{{ $variation->updated_at }}</td>
                                            <td>
                                                <x-actions.edit-btn route="admin.variations.edit" label="Edit" :route-params="[$variation->id]" />
                                                <x-actions.delete-btn route="admin.variations.destroy" label="Delete" :route-params="[$variation->id]" alertTitle="Delete {{$variation->name}}"/>
