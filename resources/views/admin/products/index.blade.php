                                ...
                                <tbody>
                                    @foreach($products as $product)
                                        <tr>
                                            ...
                                            <td>{{ $product->defaultStock->productPrice->price ?? 0 }}</td>
                                            <td>{{ $product->addedBy->name ?? "" }}</td>
                                            <td>{{ $product->updated_at }}</td>
                                            <td>
                                                <x-actions.edit-btn route="products.edit" label="Edit" :route-params="['id'=>$product->id,'step'=>1]" />
                                                <x-actions.delete-btn route="products.destroy" label="Delete" :route-params="[$product->id]" alertTitle="Delete Product {{$product->name}}"/>
