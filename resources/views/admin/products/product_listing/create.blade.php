                        ...
                        <div class="card card-primary card-tabs">
                            <div class="card-header  p-0 pt-1">
                                <div class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                    ...
                                    <div class="nav-item">
                                        <a class="nav-link font-weight-bold active" id="custom-tabs-one-profile-tab"  href="{{ route('products.create') }}" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false">
