    ...
    <div class="content-wrapper pt-3">
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{route('products.edit.stepOne')}}" method="post">
                            @csrf
                            ...
                            <div class="card card-primary card-tabs">
                                ...
                                <div class="card-body mt-4">
                                    ...
                                    <ul class="nav nav-tabs" id="tablist" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link {{$step==2?"active":""}}" id="variants_tab-tab"  @if(isset($product)) href="{{route('products.edit',["id"=>$product,"step"=>2])}}" @else href="#variants_tab" @endif >
                                                Variants
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link {{$step==3?"active":""}}" id="stock-tab" @if(isset($product)) href="{{route('products.edit',["id"=>$product,"step"=>3])}}" @else href="#stock-tab-block" @endif >
                                                Stock
                                            </a>
                                        </li>
