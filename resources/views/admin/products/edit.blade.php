                        ...
                        <div class="card card-primary card-tabs">
                            <div class="card-header p-0 pt-1">
                                ...
                                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link font-weight-bold " id="custom-tabs-one-home-tab"  href="{{ route('products.index') }}" role="tab" aria-controls="custom-tabs-one-home" aria-selected="false">
                                            <i class="fas fa-list-alt"></i>
                                            Product List
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link font-weight-bold" id="custom-tabs-one-profile-tab"  href="{{ route('products.create') }}" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false">
                                            <i class="fas fa-plus-square"></i>
                                            Add Product
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link font-weight-bold active" id="custom-tabs-one-profile-tab"  href="{{ route('products.create') }}" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="true">
                                            <i class="fas fa-edit"></i>
                                            Edit Product
                                        </a>
                                    </li>
                                    <div class="nav-item">
                                        <a class="nav-link font-weight-bold " id="custom-tabs-one-profile-tab"  href="{{ route('products.trash') }}" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false">
                            ...
                            <div class="card-body ">
                                <!-- This HTML and Blade code for Product edit form here -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ old('variant_value') }}"
...
<script >
    $(document).ready(function(){
        ...
        var $option = $("<option selected></option>").val('{{ $product->brand->id }}').text("{{ $product->brand->name }}");
        ...
        var storedData = {!! $productToVariations ? json_encode($productToVariations) : [] !!};
        ...
        function updateTableContent() {
            ...
            storedData.forEach(function(data, index) {
                ...
                if(data.id)
                {
                    newRow.append('<input type="hidden" name="variantions[id][]" value="' + data.id + '"/>');
                }
    ...
    var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
        ...
        removedfile: function (file) {
            ...
            dzRemoveFileMultiple(
                file, existing, '{!! route("products.remove.media") !!}',
