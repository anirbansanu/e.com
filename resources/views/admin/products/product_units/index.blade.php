                            ...
                            <table class="table table-hover text-nowrap border-top">
                                ...
                                <tbody>
                                    @foreach($product_units as $product_unit)
                                        <tr>
                                            <td>{{$product_units->firstItem() + $loop->index}}</td>
                                            <td>{{ $product_unit->unit_name }}</td>

                                            <td>{{ $product_unit->updated_at }}</td>
                                            <td>
                                                <x-actions.edit-btn route="admin.product_units.edit" label="Edit" :route-params="[$product_unit->id]" />
                                                <x-actions.delete-btn route="admin.product_units.destroy" label="Delete" :route-params="[$product_unit->id]" alertTitle="Delete {{$product_unit->name}}"/>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
