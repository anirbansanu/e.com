...
@section('content_body')
    <x-anilte::card headerClass="p-0 border-bottom-0 " bodyClass="" footerClass="custom-footer-class" minimize maximize close>
        <x-slot name="header">
                ...
                <x-anilte::tab-nav-item route="admin.products.attributes.edit" routeParams="{{ $attribute->id }}" icon="fas fa-plus-square">Edit Attribute <small>( {{$attribute->name }} )</small> </x-anilte::tab-nav-item>
        </x-slot>
        <x-slot name="body">
            <form action="{{route('admin.products.attributes.store')}}" method="POST">
                ...
                />
                    ...
                    <div class="form-group d-flex justify-content-between">
                        ...
                        <x-adminlte-button type="submit" label="Update Attribute" theme="primary bg-gradient-blue" class="btn-md mt-3" icon="fas fa-save"/>
                    </div>
            </form>
        </x-slot>
