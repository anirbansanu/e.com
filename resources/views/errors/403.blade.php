...
<body>
    <div class="container-fluid d-flex flex-col align-items-center justify-content-center ">
        <div class="row w-100">
            <div class="col-sm-12 col-md-6 col-lg-6">
                <svg class="aspect-video" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" >
