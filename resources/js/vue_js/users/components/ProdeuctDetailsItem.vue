            ...
            <div class="row gx-5">
                <aside class="col-lg-6">
                    ...
                    <div class="d-flex justify-content-center mb-3">
                        ...
                        <a
                            data-fslightbox="mygalley"
                            class="border mx-1 rounded- item-thumb2"
                            target="_blank"
                            data-type="image"
                            href="https://mdbcdn.b-cdn.net/img/bootstrap-ecommerce/items/detail1/big.webp"
                        >
                ...
                <main class="col-lg-6">
                    <div class="ps-lg-3">
                        ...
                        <p>
                            Modern look and quality demo item is a
                            streetwear-inspired collection that continues to
                            break away from the conventions of mainstream
                            fashion. Made in Italy, these black and brown
                            ...
                            <div class="col-md-4 col-6 mb-3">
                                ...
                                >
                                    <button
                                        ...
                                        type="button"
                                        id="button-addon1" >
                                        <i class="fa fa-minus" style="color:#b29a76;"></i>
                                    </button>
                                    <input
                                        type="text"
                                        class="form-control text-center"
                                        placeholder="14"
                                        style="border:none; color:#b29a76;"
                                    ...
                                    >
                                        <i class="fa fa-plus" style="color:#b29a76;"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div class="store-Product">
                             <a href="#" class="btn bye-now" >
                                Buy now
                            </a>
                            <a href="#" class="btn btn-primary shadow-0">
                                <i class="me-1 fa fa-shopping-basket"></i> Add to
                                cart
                            </a>
